...
# Gearing our industry Statisticians up for Software success : A `phase1b` journey.{background-iframe="moving-waves/index.html"}
...
# Why Should Statisticians make Software ?
              ...
              "Modern statistical inference is unthinkable without the use of a computer"
               _Likelihood and Bayesian Inference_ Held, Sabanés Bové (2020)
...
-   Daniel Sabanés Bové, Isaac Gravestock
