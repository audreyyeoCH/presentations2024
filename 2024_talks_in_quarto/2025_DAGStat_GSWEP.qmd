...
![](images/Design Doc.jpg){width=90%}{fig.alt="Cartoonish drawing of a dot rmd file depicting a Design Document with sections of purpose, loading relevant packages, list of input variables, helper function and user facing function}
...
8.  **Test-Driven Development (TDD)**: Write
...
9.  **Refactoring**: Regularly refactor your code to keep it clean, readable,
    and maintainable
10. **Code Review**: Have other team members
