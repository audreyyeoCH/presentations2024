...
format:
  revealjs:
    html:
    slide-number: true
    logo: images/R_in_Pharma_logo.png
    #css: logo.css
code-fold: false
chalkboard: true
footer: "Audrey Yeo"
...
business assumptions and strategies
  ...
  - Expectations from health authorities and post-marketing needs
...
# Questions, Feedback and Collaborations{background-iframe="rubik/index.html"}
